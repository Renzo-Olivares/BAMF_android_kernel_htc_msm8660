...
void vigor_snddev_emic_pamp_on(int en)
{
	...
	if (en) {
		...
		gpio_request(PM8058_GPIO_PM_TO_SYS(VIGOR_AUD_2V85_EN), "AUD_2V85_EN");
		gpio_direction_output(PM8058_GPIO_PM_TO_SYS(VIGOR_AUD_2V85_EN), 1);
	} else {
		gpio_request(PM8058_GPIO_PM_TO_SYS(VIGOR_AUD_2V85_EN), "AUD_2V85_EN");
		gpio_direction_output(PM8058_GPIO_PM_TO_SYS(VIGOR_AUD_2V85_EN), 0);
	}
#endif
}
...
void vigor_audio_gpios_init(void)
{
	pr_aud_info("%s\n", __func__);
}
